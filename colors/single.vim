...
let s:dark_pink       = { "gui": "#ff5f87"}
let s:light_pink      = { "gui": "#d75f87"}
let s:dark_red        = { "gui": "#C30771"}
let s:light_red       = { "gui": "#E32791"}
let s:lightest_red    = { "gui": "#FCD5D2"}
let s:most_red        = { "gui": "#ec2100"}
let s:dark_blue       = { "gui": "#008EC4"}
let s:blue            = { "gui": "#20BBFC"}
let s:light_blue      = { "gui": "#b6d6fd"}
let s:dark_cyan       = { "gui": "#20A5BA"}
let s:light_cyan      = { "gui": "#4FB8CC"}
let s:dark_green      = { "gui": "#10A778"}
let s:lightest_green  = { "gui": "#CAFFD8"}
let s:light_green     = { "gui": "#5FD7A7"}
let s:light_purple    = { "gui": "#a790d5"}
let s:yellow          = { "gui": "#F3E430"}
let s:light_yellow    = { "gui": "#ffff87"}
let s:dark_yellow     = { "gui": "#A89C14"}
let s:github_bg       = { "gui": "#f4f4f4"}
let s:main_color      = { "gui": "#a94dbb"}
...
let s:main            = s:main_color
let s:cyan            = s:dark_cyan
let s:green           = s:dark_green
let s:red             = s:dark_red
let s:visual          = s:main_color
let s:yellow          = s:dark_yellow
let s:string          = s:lightest_gray
let s:special         = s:main
...
call s:h("Cursor",        {"bg": s:medium_gray, "fg": s:norm })
...
call s:h("Todo",          {"fg": s:main, "gui": "underline", "cterm": "underline"})
...
call s:h("Visual",        {"fg": s:white, "bg": s:medium_gray})
...
call s:h("TabLineSel",    {"fg": s:white, "bg": s:medium_gray, "gui": "bold"})
...
" HTML content
call s:h("htmlH1",                    {"fg": s:norm,        "gui": "bold,reverse" })
call s:h("htmlH2",                    {"fg": s:norm,        "gui": "reverse"      })
call s:h("htmlH3",                    {"fg": s:norm,        "gui": "bold"         })
call s:h("htmlH4",                    {"fg": s:norm,        "gui": "italic"       })
...
call s:h("markdownH1",                {"fg": s:norm,        "gui": "bold,reverse" })
call s:h("markdownH1Delimiter",       {"fg": s:norm,        "gui": "bold,reverse" })
call s:h("markdownH2",                {"fg": s:norm,        "gui": "reverse"      })
call s:h("markdownH2Delimiter",       {"fg": s:norm,        "gui": "reverse"      })
call s:h("markdownH3",                {"fg": s:norm,        "gui": "bold"         })
call s:h("markdownH3Delimeter",       {"fg": s:norm,        "gui": "bold"         })
call s:h("markdownH4",                {"fg": s:norm,        "gui": "italic"       })
call s:h("markdownH4Delimiter",       {"fg": s:norm,        "gui": "italic"       })
call s:h("markdownH5",                {"fg": s:norm                               })
call s:h("markdownH5Delimiter",       {"fg": s:norm                               })
call s:h("markdownH6",                {"fg": s:norm                               })
call s:h("markdownH6Delimiter",       {"fg": s:norm                               })
...
call s:h("markdownCode",              {"fg": s:norm, "bg": s:string               })
call s:h("markdownCodeDelimiter",     {"fg": s:norm, "bg": s:string               })
