...
" HTML content
call s:h("htmlH1",        {"fg": s:norm, "gui": "bold,italic", "cterm": "bold"     })
call s:h("htmlH2",        {"fg": s:norm, "gui": "bold"       , "cterm": "bold"     })
call s:h("htmlH3",        {"fg": s:norm, "gui": "italic"     , "cterm": "italic"   })
call s:h("htmlH4",        {"fg": s:norm, "gui": "italic"     , "cterm": "italic"   })
...
call s:h("markdownH1",                  {"fg": s:norm, "gui": "bold,italic", "cterm": "bold"  })
call s:h("markdownH2",                  {"fg": s:norm, "gui": "bold"       , "cterm": "bold"  })
call s:h("markdownH3",                  {"fg": s:norm, "gui": "italic"     , "cterm": "italic"})
call s:h("markdownH4",                  {"fg": s:norm, "gui": "italic"     , "cterm": "italic"})
