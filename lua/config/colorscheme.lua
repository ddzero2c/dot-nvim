...
vim.api.nvim_create_autocmd("OptionSet", {
    ...
    callback = function()
        ...
        setup_colors(vim.v.option_new)
    end,
})

function setup_colors(bg)
    if bg == 'dark' then
    ...
    local highlight_links = {
        ...
        Statement = { 'PreProc' },
        LineNr = { 'SignColumn', 'ColorColumn', 'RenderMarkdownCodeBorder', 'TreesitterContextSeparator' },
    }
